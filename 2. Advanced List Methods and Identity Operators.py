# Problem Statement: You have two lists of student names. One list 
# contains the names of students who have submitted their assignments, 
...
if "Alice" in submitted and attended:
    print("Alice has submitted the assignment and attended class.")
else:
    print("Alice is not on one or both of the lists.")